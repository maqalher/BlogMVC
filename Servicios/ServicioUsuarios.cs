...
public interface IServicioUsuarios
{
    ...
    Task<bool> PuedeUsuarioHacerCRUDEnradas();
...
public class ServicioUsuarios: IServicioUsuarios
{
    ...
    private static readonly string[] RolesBorrarComentarios = {Constantes.RolAdmin, Constantes.BorrarComentarios};
    ...
    public async Task<bool> PuedeUsuarioHacerCRUDEnradas()
    {
