...
public class EntradasController: Controller
{
    ...
    public async Task<IActionResult> Detalle(int id)
    {
        ...
        var puedeEditarEntradas = await servicioUsuarios.PuedeUsuarioHacerCRUDEnradas();
        ...
        var modelo = new EntradaDetalleViewModel
        {
            ...
            EscritoPor = entrada.UsuarioActualizacion?.Nombre ?? "Usuario desconocido",
    ...
    public async Task<IActionResult> GenerarImagen([FromQuery] string titulo)
    {
        ...
        // {
        //     var rutaImage = Path.Combine(env.WebRootPath, "img", "ia.png");
        //     var imagenBytes = await System.IO.File.ReadAllBytesAsync(rutaImage);
